...
```javascript
strides = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-strides@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-strides/tags). For example,

```javascript
strides = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-strides@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var strides = require( 'path/to/vendor/umd/ndarray-strides/index.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/ndarray-strides.svg
[npm-url]: https://npmjs.org/package/@stdlib/ndarray-strides

[test-image]: https://github.com/stdlib-js/ndarray-strides/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/ndarray-strides/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/ndarray-strides/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/ndarray-strides?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/ndarray-strides.svg
[dependencies-url]: https://david-dm.org/stdlib-js/ndarray-strides/main
...
[deno-readme]: https://github.com/stdlib-js/ndarray-strides/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/ndarray-strides/tree/umd
[umd-readme]: https://github.com/stdlib-js/ndarray-strides/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/ndarray-strides/tree/esm
[esm-readme]: https://github.com/stdlib-js/ndarray-strides/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/ndarray-strides/blob/main/branches.md
